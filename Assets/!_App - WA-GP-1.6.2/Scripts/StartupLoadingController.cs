...
{
#if UNITY_EDITOR
    public string Version = "WA-GP-1.6.2";
#endif


    [SerializeField] private bool _isLandscapeModeGame = false;
    ...
    private void CheckGraphicsSetup(Transform[] transforms)
    {
        ...
        try
        {
            var navBackground =  transforms.First(tr => tr.gameObject.name == "NavBackground").GetChild(0).GetComponent<Image>();
